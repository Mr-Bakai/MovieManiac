//
//  TopRatedTVSeriesCollectionViewCell.swift
//  MovieManiac
//
...
class TopRatedTVSeriesCollectionViewCell: UICollectionViewCell {
    
    private let imageView = UIImageView()
    static let identifier = "TopRatedTVSeriesCollectionViewCell"
    ...
    public func configure(with model: TopRatedTVSeriesCellViewModel){
...
// MARK: - UI Setup
extension TopRatedTVSeriesCollectionViewCell {
